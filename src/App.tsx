      ...
      <Suspense fallback={<Preloader />}>
        <ErrorBoundary>
          <Routes>
            ...
            <Route path="/partner-certificate" element={<PartnerCertificatePage />} />
            <Route path="/veriff/callback" element={<VeriffCallbackPage />} />
            <Route path="/lovepay-adm" element={<LovePayAdminPage />} />
            ...
            <Route path="/lovepay/login" element={<LovePayLoginPage />} />
            ...
            <Route path="/myes/login" element={<MyesLoginPage />} />
