-- =============================================
-- MIGRATION: Add Referral System for Buyers
-- Date: 2025-09-22
-- Description: Creates referral system for buyers with 0.35% commission
-- =============================================
...
-- 4. Add referral tracking to profiles
ALTER TABLE profiles
ADD COLUMN IF NOT EXISTS referred_by UUID REFERENCES profiles(id) ON DELETE SET NULL,
ADD COLUMN IF NOT EXISTS referral_earnings_usdt DECIMAL(15,2) DEFAULT 0,
...
-- 13. Trigger to auto-create referral codes
...
-- 15. Function to apply referral code during registration
...
-- 16. Create view for referral statistics
